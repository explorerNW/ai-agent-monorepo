...
const FeedHeader: React.FC<FeedHeaderProps> = React.memo(({ avatarUrl, sinceLastVisitCount }) => {
  return (
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex-1">
          <p className="text-[#AEBECE] text-xs font-medium leading-4 tracking-tight mb-2">
            {'Since last visit:'}{' '}
            <span className="text-[#FFFFFF]">{sinceLastVisitCount} new publishes</span>
          </p>
          <h1 className="text-white text-[34px] font-bold leading-[41px] tracking-wide">New</h1>
        </div>
